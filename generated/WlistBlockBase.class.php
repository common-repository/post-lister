...
abstract class WlistBlockBase
{
	 ...
	 * The widget name.
	 */
	const BLOCK_LOCALE_GENRATED_NAME = 'post-lister-wlist';

	/**
	 * The shortcode tag name.
	 */
	const SHORTCODE_NAME = 'wlist';

	/**
	 * The widget name.
	 */
	const WIDGET_NAME = 'wlist';
	
	/**
	 * The widget class.
	 */
	const WIDGET_CLASS = 'wlist';
	...
	public function widgetConfigurator($widgetArgs = array())
	{
		...
		// Set 'filter'.
		$fieldNames['cat'] = 'cat';
		$fieldNames['category_name'] = 'category_name';
		$fieldNames['tag'] = 'tag';
		...
		$fieldNames['showcommentcount'] = 'showcommentcount';
		...
		// Set 'global'.		
		$form[] = '<fieldset style="' . $fieldsetStyle . '"><legend style="' . $legendStyle . '">' . __('wlist-set-global-label', self::BLOCK_LOCALE_GENRATED_NAME) . '</legend>';
		$form[] = '<p>';
		$form[] = $this->getTextField($number, 'title', 'wlist-parameter-title-label', $thisOptions['title']);
		$form[] = '</p>';
		$form[] = '<p>';
		$form[] = $this->getTextField($number, 'limit', 'wlist-parameter-limit-label', $thisOptions['limit']);
		$form[] = '</p>';
		$form[] = '</fieldset>';

		// Set 'sort'.		
		$form[] = '<fieldset style="' . $fieldsetStyle . '"><legend style="' . $legendStyle . '">' . __('wlist-set-sort-label', self::BLOCK_LOCALE_GENRATED_NAME) . '</legend>';
		$form[] = '<p>';
		$fieldOptions = array();
		$fieldOptions[] = array('value' => 'desc', 'nameKey' => 'wlist-parameter-order-option-desc-label');
		$fieldOptions[] = array('value' => 'asc', 'nameKey' => 'wlist-parameter-order-option-asc-label');
		$form[] = $this->getSelectField($number, 'order', 'wlist-parameter-order-label', $thisOptions['order'], $fieldOptions);
		$form[] = '</p>';
		$form[] = '<p>';
		$fieldOptions = array();
		$fieldOptions[] = array('value' => 'date', 'nameKey' => 'wlist-parameter-orderby-option-date-label');
		$fieldOptions[] = array('value' => 'author', 'nameKey' => 'wlist-parameter-orderby-option-author-label');
		$fieldOptions[] = array('value' => 'title', 'nameKey' => 'wlist-parameter-orderby-option-title-label');
		$fieldOptions[] = array('value' => 'modified', 'nameKey' => 'wlist-parameter-orderby-option-modified-label');
		$fieldOptions[] = array('value' => 'rand', 'nameKey' => 'wlist-parameter-orderby-option-rand-label');
		$form[] = $this->getSelectField($number, 'orderby', 'wlist-parameter-orderby-label', $thisOptions['orderby'], $fieldOptions);
		$form[] = '</p>';
		$form[] = '</fieldset>';
		$form[] = '<hr style="' . $hrStyle . '" />';

		// Set 'filter'.		
		$form[] = '<fieldset style="' . $fieldsetStyle . '"><legend style="' . $legendStyle . '">' . __('wlist-set-filter-label', self::BLOCK_LOCALE_GENRATED_NAME) . '</legend>';
		$form[] = '<p>';
		$form[] = $this->getTextField($number, 'cat', 'wlist-parameter-cat-label', $thisOptions['cat']);
		$form[] = '</p>';
		$form[] = '<p>';
		$form[] = $this->getTextField($number, 'category_name', 'wlist-parameter-category_name-label', $thisOptions['category_name']);
		$form[] = '</p>';
		$form[] = '<p>';
		$form[] = $this->getTextField($number, 'tag', 'wlist-parameter-tag-label', $thisOptions['tag']);
		$form[] = '</p>';
		$form[] = '<p>';
		$form[] = $this->getTextField($number, 'author', 'wlist-parameter-author-label', $thisOptions['author']);
		$form[] = '</p>';
		$form[] = '<p>';
		$form[] = $this->getTextField($number, 'author_name', 'wlist-parameter-author_name-label', $thisOptions['author_name']);
		$form[] = '</p>';
		$form[] = '</fieldset>';

		// Set 'display'.		
		$form[] = '<fieldset style="' . $fieldsetStyle . '"><legend style="' . $legendStyle . '">' . __('wlist-set-display-label', self::BLOCK_LOCALE_GENRATED_NAME) . '</legend>';
		$form[] = '<p>';
		$form[] = $this->getCheckboxField($number, 'showauthor', 'wlist-parameter-showauthor-label', $thisOptions['showauthor']);
		$form[] = '</p>';
		$form[] = '<p>';
		$form[] = $this->getCheckboxField($number, 'showdate', 'wlist-parameter-showdate-label', $thisOptions['showdate']);
		$form[] = '</p>';
		$form[] = '<p>';
		$form[] = $this->getCheckboxField($number, 'showtime', 'wlist-parameter-showtime-label', $thisOptions['showtime']);
		$form[] = '</p>';
		$form[] = '<p>';
		$form[] = $this->getCheckboxField($number, 'showcommentcount', 'wlist-parameter-showcommentcount-label', $thisOptions['showcommentcount']);
		$form[] = '</p>';
		$form[] = '<p>';
		$fieldOptions = array();
		$fieldOptions[] = array('value' => 'none', 'nameKey' => 'wlist-parameter-showauthoravatar-option-none-label');
		$fieldOptions[] = array('value' => '32', 'nameKey' => 'wlist-parameter-showauthoravatar-option-32-label');
		$fieldOptions[] = array('value' => '64', 'nameKey' => 'wlist-parameter-showauthoravatar-option-64-label');
		$fieldOptions[] = array('value' => '96', 'nameKey' => 'wlist-parameter-showauthoravatar-option-96-label');
		$fieldOptions[] = array('value' => '128', 'nameKey' => 'wlist-parameter-showauthoravatar-option-128-label');
		$form[] = $this->getSelectField($number, 'showauthoravatar', 'wlist-parameter-showauthoravatar-label', $thisOptions['showauthoravatar'], $fieldOptions);
		$form[] = '</p>';
		$form[] = '<p>';
		$fieldOptions = array();
		$fieldOptions[] = array('value' => 'none', 'nameKey' => 'wlist-parameter-showtext-option-none-label');
		$fieldOptions[] = array('value' => '25', 'nameKey' => 'wlist-parameter-showtext-option-25-label');
		$fieldOptions[] = array('value' => '50', 'nameKey' => 'wlist-parameter-showtext-option-50-label');
		$fieldOptions[] = array('value' => '75', 'nameKey' => 'wlist-parameter-showtext-option-75-label');
		$fieldOptions[] = array('value' => '100', 'nameKey' => 'wlist-parameter-showtext-option-100-label');
		$fieldOptions[] = array('value' => '150', 'nameKey' => 'wlist-parameter-showtext-option-150-label');
		$fieldOptions[] = array('value' => '200', 'nameKey' => 'wlist-parameter-showtext-option-200-label');
		$fieldOptions[] = array('value' => '300', 'nameKey' => 'wlist-parameter-showtext-option-300-label');
		$fieldOptions[] = array('value' => 'all', 'nameKey' => 'wlist-parameter-showtext-option-all-label');
		$form[] = $this->getSelectField($number, 'showtext', 'wlist-parameter-showtext-label', $thisOptions['showtext'], $fieldOptions);
		$form[] = '</p>';
		$form[] = '</fieldset>';
		$form[] = '<hr style="' . $hrStyle . '" />';
	...
	protected function getValuesFromAttributes($attributes, $evaluate = false)
	{
		...
		$values['showcommentcount'] = 'false';
		$values['showauthoravatar'] = 'none';
		$values['showtext'] = 'none';
		$values['showtitle'] = 'true';

		// Alias attributes.
		$aliases = array();
		$aliases['showposts'] = 'limit';
